...
import { GridContainer, PhotoCard, PhotoImage, PhotoOverlay, PhotoInfo, PhotoActions, ActionButton } from '../styles/GalleryPhotoGridStyles';
...
const GalleryPhotoGridComp = ({ onPhotoSelect, onLike, onComment, onShare }) => {
  ...
  const { photos, loading, error } = useGalleryPhotoGrid();
